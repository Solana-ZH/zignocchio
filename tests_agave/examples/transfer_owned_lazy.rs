...
#[tokio::test]
async fn test_transfer_owned_lazy_happy() {
    let pid = program_id();
    ...
    program_test.add_program("transfer-owned-lazy", pid, None);
    ...
    assert!(result.is_ok(), "transfer-owned-lazy should succeed: {:?}", result);
